...
**
** Created: Sat 6. Oct 18:53:09 2012
...
static const char qt_meta_stringdata_formLogin[] = {
    "formLogin\0\0slotLogin()\0"
};
...
const QMetaObjectExtraData formLogin::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject formLogin::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_formLogin,
      qt_meta_data_formLogin, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &formLogin::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_formLogin))
