...
**
** Created: Sat 6. Oct 18:53:06 2012
...
static const char qt_meta_stringdata_form_DownloadBooks[] = {
    "form_DownloadBooks\0\0slotGetBooks()\0"
    "slotUploadBooks()\0slotPrepareFiles()\0"
    "bd\0slotChangeBD(QString)\0slotlogin()\0"
};
...
const QMetaObjectExtraData form_DownloadBooks::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject form_DownloadBooks::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_form_DownloadBooks,
      qt_meta_data_form_DownloadBooks, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &form_DownloadBooks::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_form_DownloadBooks))
