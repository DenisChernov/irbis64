...
struct qt_meta_stringdata_form_BookWork_t {
    QByteArrayData data[4];
    char stringdata[47];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    offsetof(qt_meta_stringdata_form_BookWork_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData) \
    )
static const qt_meta_stringdata_form_BookWork_t qt_meta_stringdata_form_BookWork = {
    {
...
QT_MOC_LITERAL(3, 32, 13)
    ...
    "form_BookWork\0slotSearchByISBN\0\0"
    "slotViewBooks\0"
};
...
const QMetaObject form_BookWork::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_form_BookWork.data,
      qt_meta_data_form_BookWork,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_form_BookWork.stringdata))
