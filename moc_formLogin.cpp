...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_formLogin_t, stringdata) + ofs \
...
const QMetaObject formLogin::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_formLogin.data,
      qt_meta_data_formLogin,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_formLogin.stringdata))
