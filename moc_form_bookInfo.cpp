...
struct qt_meta_stringdata_form_bookInfo_t {
    QByteArrayData data[4];
    char stringdata[44];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    offsetof(qt_meta_stringdata_form_bookInfo_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData) \
    )
static const qt_meta_stringdata_form_bookInfo_t qt_meta_stringdata_form_bookInfo = {
    {
...
QT_MOC_LITERAL(3, 29, 13)
    ...
    "form_bookInfo\0slot_nextBook\0\0slot_prevBook\0"
};
...
const QMetaObject form_bookInfo::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_form_bookInfo.data,
      qt_meta_data_form_bookInfo,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_form_bookInfo.stringdata))
